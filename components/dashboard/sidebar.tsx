...
export function Sidebar() {
  return (
    <aside className="hidden md:flex h-screen w-72 flex-col fixed inset-y-0 border-r bg-background">
      <div className="flex h-16 items-center gap-2 border-b px-6">
        <Logo />
      </div>
      <div className="flex-1 overflow-y-auto">
        <nav className="space-y-1.5 p-6">
          <div className="mb-4">
          ...
          {/* AI Personalized Exercise Section */}
          <div className="mt-6">
            <h2 className="px-2 text-lg font-semibold tracking-tight">
          ...
          <SidebarItem
            href="/dashboard/exercises/recommended"
            label="Recommended"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
